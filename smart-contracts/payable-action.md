...
생성자는 hodl\_symbol 을 "SYS"로 초기화 합니다. SYS 는 [토큰 배포, 발급 및 전송](contract-dev-workflow.md) 단원에서 만들었던 토큰입니다.
...
on\_notify 는 EOSIO.CDT의 속성 중 하나로 스마트 컨트랙트 액션에 달 수 있는 어노테이션 입니다.
