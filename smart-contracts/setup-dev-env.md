...
본 문서의 튜토리얼을 학습한 후 어느 정보 Antelope 노드 사용법과 스마트 컨트랙트 개발에 대한 기본에 익숙해졌다면 이 도구를 이용하여 개발 환경을 구축하는 것을 추천합니다. 설정 방법과 간단한 사용법을 [컨테이너 기반 Antelope 노드 실행 도구 D.U.N.E ](antelope-leap-dune.md)에서 다루고 있으니 이를 참조하여 개발 환경을 구축할 수 있습니다.
