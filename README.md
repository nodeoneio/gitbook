...
그리고 2022년 9월 21일, 마침내 성공적으로 EOS 메인넷을 Antelope 기반으로 전환하였습니다.
...
ENF 에서도 자체적으로 [개발자 가이드 문서](http://docs.eosnetwork.com/)를 만들고 있지만 한국의 개발자를 위하여 한글화 된 최신 정보는 거의 없다시피 한 게 현실입니다.
